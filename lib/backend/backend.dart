...
import 'schema/play_list_record.dart';
...
export 'schema/play_list_record.dart';
...
Future<FFFirestorePage<ArtistRecord>> queryArtistRecordPage({
  Query Function(Query) queryBuilder,
...
Future<FFFirestorePage<PlayListRecord>> queryPlayListRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
...
Future<FFFirestorePage<SongsRecord>> querySongsRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
