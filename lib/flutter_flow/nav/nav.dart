...
class AppStateNotifier extends ChangeNotifier {
  SparkFM2FirebaseUser initialUser;
  SparkFM2FirebaseUser user;
  ...
  void update(SparkFM2FirebaseUser newUser) {
    initialUser ??= newUser;
    user = newUser;
...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, _) =>
          appStateNotifier.loggedIn ? NavBarPage() : SignInDemoWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
          ...
          routes: [
            ...
            FFRoute(
              ...
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'LiveRadioTabDemo')
            ...
            FFRoute(
              ...
              path: 'browseDemo',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'BrowseDemo')
                  : BrowseDemoWidget(),
            ),
            FFRoute(
              name: 'NewsFeedDemo',
              path: 'newsFeedDemo',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'NewsFeedDemo')
                  : NewsFeedDemoWidget(),
            ),
            FFRoute(
              name: 'SparkTVDemo',
              path: 'sparkTVDemo',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'SparkTVDemo')
                  : SparkTVDemoWidget(
                      youtubeId: params.getParam('youtubeId', ParamType.String),
                    ),
            ),
            FFRoute(
              name: 'ChatroomDemo',
              path: 'chatroomDemo',
              builder: (context, params) => params.isEmpty
                  ? NavBarPage(initialPage: 'ChatroomDemo')
                  : ChatroomDemoWidget(),
            ),
            FFRoute(
              name: 'ChatPage',
            ...
            FFRoute(
              name: 'SongListDemo',
              path: 'songListDemo',
              builder: (context, params) => SongListDemoWidget(),
            ),
            FFRoute(
            ...
            FFRoute(
              name: 'ViewAllDemo',
              path: 'viewAllDemo',
              builder: (context, params) => ViewAllDemoWidget(),
            ),
            FFRoute(
              name: 'PodcastsDemo',
              path: 'podcastsDemo',
              builder: (context, params) => PodcastsDemoWidget(),
            ),
            FFRoute(
